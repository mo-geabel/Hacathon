...
export default function UrgentModal({ isOpen, minutesLeft, bookingId }: UrgentModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/90 backdrop-blur-md animate-fade-in">
      ...
      <div className="bg-white dark:bg-navy-800 border border-red-500/30 rounded-2xl p-8 max-w-md w-full text-center relative z-10 shadow-[0_0_50px_rgba(239,68,68,0.2)] animate-slide-up">
        
        <div className="w-20 h-20 bg-red-500/20 rounded-full flex items-center justify-center mx-auto mb-6 animate-pulse">
          <AlertOctagon className="w-10 h-10 text-red-500" />
        </div>

        <h2 className="text-2xl font-bold text-foreground mb-2">Room is Empty!</h2>
        ...
        <p className="text-sm text-slate-500 dark:text-gray-400 bg-red-500/10 p-4 rounded-lg border border-red-500/20">
