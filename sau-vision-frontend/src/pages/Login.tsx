        ...
        <div className="relative z-20 flex flex-col justify-end p-16 h-full text-white max-w-2xl">
          <div className="flex items-center gap-4 mb-8">
            <div className="w-14 h-14 rounded-2xl bg-electric-500/20 flex items-center justify-center border border-electric-500/30 backdrop-blur-sm">
              <Library className="w-7 h-7 text-electric-400" />
            </div>
            <div>
              <h1 className="text-3xl font-serif font-bold tracking-tight text-white">Sakarya University</h1>
              <p className="text-electric-400/90 font-medium tracking-wide text-sm uppercase mt-1">SAÜ-Vision Portal</p>
            </div>
          </div>
          <blockquote className="space-y-6">
            ...
            <footer className="flex items-center gap-3">
              <div className="h-px w-12 bg-electric-500/50" />
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-20 xl:px-32 relative">
        ...
        <div className="w-full max-w-md mx-auto relative z-10">
          <div className="lg:hidden flex items-center gap-3 mb-10">
            ...
            <div>
              <h2 className="text-xl font-serif font-bold text-foreground dark:text-white tracking-tight">Sakarya University</h2>
              <p className="text-electric-400/90 text-xs font-medium uppercase tracking-widest mt-0.5">SAÜ-Vision</p>
            </div>
          </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    className="appearance-none block w-full px-4 py-3 border border-border rounded-xl shadow-sm placeholder-gray-500 bg-background/50 text-foreground focus:outline-none focus:ring-2 focus:ring-electric-500/50 focus:border-electric-500/50 sm:text-sm transition-all"
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 bg-background border-border rounded text-electric-500 focus:ring-electric-500"
                  />
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-navy-900 bg-electric-400 hover:bg-electric-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-electric-500 focus:ring-offset-[#0d1829] transition-all disabled:opacity-50 disabled:cursor-not-allowed items-center gap-2"
                >
                  {isLoading ? (
                    <>
